...
REAL(4), PARAMETER           :: PC_MinPit     =       -1.0                       ! Minimum pitch setting in pitch controller, rad.
...
REAL(4), PARAMETER           :: VS_Rgn2K      =       1.7                  ! Generator torque constant in Region 2 (HSS side), N-m/(rad/s)^2.
